...
import { Container, HeaderWrapper, Menu, MenuBurger, MenuItem, RightMenu, Search, Cart, Title, Wrapper, CartItemCount } from "./styled";
          ...
          <RightMenu>
            <Search>
              <form onSubmit={handleSearchSubmit}>
                <input placeholder="Cari produk" className={styled.input} onChange={handleSearch} />
              </form>
            </Search>
            <Cart ml="18px" displayMobile="none" width="28px" onClick={() => toggleShowCart()}>
              {state.cart.totalItem > 0 && <CartItemCount>{state.cart.totalItem}</CartItemCount>}
              <Image src="/assets/icon-cart.svg" alt="cart" width="100%" height="100%" layout="responsive" objectFit="contain" />
            </Cart>
          </RightMenu>
          <MenuBurger>
